...
class Comment extends Model
{
    ...
    */
    ...
    public function setId(int $id): void { $this->attributes['id'] = $id; }
    ...
    public function getProductId(): int { return $this->attributes['product_id']; }
    Public function setProductId(int $pId): void { $this->attributes['product_id'] = $pId; }
